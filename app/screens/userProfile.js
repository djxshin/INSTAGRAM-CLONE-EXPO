        ...
        return(
            <View style={{flex: 1}}>
                {this.state.loaded == false ? (
                    ...
                    <View style={{flex:1}}>
                    <View style={{ flexDirection:"row", height:70, paddingTop: 30, backgroundColor: 'white',  borderColor: 'lightgrey', borderBottomWidth: 0.5, justifyContent: 'center', justifyConent:'space-between', alignItems: 'center'}}>
